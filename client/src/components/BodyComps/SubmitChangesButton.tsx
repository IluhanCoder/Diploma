...
const SubmitChangesButton = (params: LocalParams) => {   
    ...
    if(params.display) return <button type="button" className="flex justify-center bg-green-300 p-2 rounded hover:bg-green-100" onClick={handleButtonClick}>Застосувати зміни</button>
    else return <></>
}
