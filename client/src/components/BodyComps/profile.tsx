...
import ExtraInput from './ExtraForm';
                            ...
                            <div className='flex flex-col justify-center space-y-5'>
                                <div className='flex flex-row w-full'>
                                    ...
                                    <div className='w-full flex flex-row-reverse'>
                                        <ExtraInput value={login} editMode={editMode} setValue={setLogin}/>
                                    </div>
                                </div>
                                <div className='flex flex-row'>
                                    <p>Email</p>
                                    <div className='w-full flex flex-row-reverse'>
                                        <ExtraInput value={email} editMode={editMode} setValue={setEmail}/>
                                    </div>
                                </div>
                                <div className='flex flex-row'>
                                    <p>Дата народження</p>
                                ...
                                <div className='flex flex-row'>
                                    <p>Номер телефону</p>
                                    <div className='w-full flex flex-row-reverse'>
                                        <ExtraInput value={cell} editMode={editMode} setValue={setCell}/>
                                    </div>
                                </div>
                                <div className='flex flex-row'>
                                    <p>Місто</p>
                                    <div className='w-full flex flex-row-reverse'>
                                        <ExtraInput value={city} editMode={editMode} setValue={setCity}/>
                                    </div>
                                </div>
                                <div className='flex flex-row'>
                                    <p>Стать</p>
                                    <div className='w-full flex flex-row-reverse'>
                                        <ExtraInput value={gender} editMode={editMode} setValue={setGender}/>
                                    </div>
                                </div>
                            </div>
                            <div className='flex justify-center p-8'>
                                <div>
                                    <SubmitChangesButton display={editMode} user={currentUser} email={email} 
                                    login={login} cell={cell} city={city} gender={gender}/>
                                </div>
                            </div>
                        </div>
                    </div>
